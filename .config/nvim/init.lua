...
-- Make the background transparent, regardless of theme
...
-- Automatically save files when changing buffers or quitting
vim.opt.autowrite = true
vim.opt.autowriteall = true

-- Reload files when updated outside vim
...
vim.pack.add { gh 'ariedov/android-nvim' }
